...
const ProductsContainer: React.FC<ProductsContainerProps> = ({
  ...
  // Get products for the current page slice
  ...
  useEffect(() => {
    // When filtered products change, update min and max prices for filters
  ...
  }, [filteredProducts, handleMinPriceChange, handleMaxPriceChange]);

  // Show message if no products found in the filtered price range
