    ...
    return (
        <article className="product-card rounded-2xl overflow-hidden bg-white shadow-md flex flex-col h-full">
            ...
            <div className="px-6 py-4 flex flex-col justify-between h-full">
                ...
                <a className="btn-primary bg-violet-500 text-white text-sm font-semibold text-center px-4 py-2 mt-auto rounded-lg col-span-4 hover:bg-violet-600 transition-colors" href={product.url} target="_blank">Zjistit více</a>
            </div>
        </article>
    );
};
